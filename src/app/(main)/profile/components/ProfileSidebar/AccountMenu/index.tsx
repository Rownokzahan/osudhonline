...
import { FiBox, FiMapPin, FiBookmark, FiShield, FiInfo } from "react-icons/fi";
import SignOutButton from "./SignOutButton";

const menuItems = [
  { label: "My orders", icon: FiBox, href: "/profile/orders" },
  { label: "My addresses", icon: FiMapPin, href: "/profile/address" },
  { label: "Saved for later", icon: FiBookmark, href: "/wishlist" },
